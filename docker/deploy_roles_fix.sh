...
cp -f "$SRC/hrms/public/js/peoplepay360_ui.js" /home/frappe/benches/frappe-bench/sites/assets/hrms/js/
cp -f "$SRC/hrms/public/js/peoplepay360_landing.js" /home/frappe/benches/frappe-bench/sites/assets/hrms/js/
chown -R frappe:frappe "$DST/hrms/www" "$DST/hrms/peoplepay360" "$DST/hrms/public/js" /home/frappe/benches/frappe-bench/sites/assets/hrms/js || true

cd /home/frappe/benches/frappe-bench
runuser -u frappe -- env HOME=/home/frappe bench --site hrms.localhost execute hrms.peoplepay360.roles.apply_peoplepay360_role_permissions
runuser -u frappe -- env HOME=/home/frappe bench --site hrms.localhost reload-doc hr workspace peoplepay360 || true
